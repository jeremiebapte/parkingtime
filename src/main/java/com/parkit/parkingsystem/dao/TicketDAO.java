/**
 * Class permettant de communiquer l'entrée d'un ticket en Base de données
 */
...
public class TicketDAO {
    ...
    public final boolean saveTicket(Ticket ticket) {
        Connection con = null;
        try {
    ...
    public final Ticket getTicket(String vehicleRegNumber) {
        Connection con = null;
        Ticket ticket = null;
        try {
            con = dataBaseConfig.getConnection();
    ...
    public final boolean updateTicket(Ticket ticket) {
        Connection con = null;
        try {
            con = dataBaseConfig.getConnection();
    ...
    public final int countInsideVehicle(String vehicleRegNumber, ParkingType vehicleType) {
        Connection con = null;
        int entry = 0;
        try {
            con = dataBaseConfig.getConnection();
    ...
    public final boolean verifyExistingVehicle(String vehicleRegNumber, ParkingType vehicleType) {
